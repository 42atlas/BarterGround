...
const Home = () => {
  ...
  return user && <div className="main-container" >
    <div className="nes-container is-centered with-title" id="landing">
      ...
      <div className="internal-container">
        ...
        <div className="home-container">
          ...
          >
            <span className={alertOffers}>{/* {offers} */} New Offers!!</span> {/* THIS */}
          </div>
          ...
          >
            <span className={alertMessages}>{/* {messages} */} New Messages!!</span> {/* THIS */}
          </div>
        </div>
        <div>{renderCharacter(user.character)}
        </div>
      </div>
    </div>
